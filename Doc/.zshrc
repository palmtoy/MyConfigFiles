...
plugins=(git github osx node npm nvm brew colorize command-not-found copydir copyfile cp dircycle docker kubectl zsh-autosuggestions zsh-completions zsh-syntax-highlighting)
...
export PATH=~/Library/Bin:/usr/local/bin:/usr/local/opt/mysql@5.7/bin:/opt/redis/current/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:$MONGODB_BIN:$PATH
...
# export PATH=$HOME/esp/xtensa-lx106-elf/bin:$PATH # for ESP8266
...
# export PATH=$(pyenv root)/shims:$PATH  # TODO: fix it for AppleM3
