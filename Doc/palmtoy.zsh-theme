PROMPT='%{$fg_no_bold[blue]%}%n%{$fg_no_bold[magenta]%}♬%{$fg_no_bold[cyan]%}%5~$(git_prompt_info)$(git_remote_status)%{$fg_no_bold[blue]%})%{$reset_color%}» '
RPROMPT='[%*]'
...
ZSH_THEME_GIT_PROMPT_DIVERGED_REMOTE="%{$fg_no_bold[magenta]%}↕"
